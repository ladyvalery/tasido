...
<?php  } ?>
    ...
    <div id="footer">
        ...
        <?php /* 
            ...
            You can buy this theme without footer links online at http://fthemes.com/buy/?theme=worldtravel
        */ ?>
        
        <div id="credits">Powered by TasidoTours<strong></strong></a> | Theme Designed by: <?php echo wp_theme_credits(0); ?>  | Thanks to <?php echo wp_theme_credits(1); ?>, <?php echo wp_theme_credits(2); ?> and <?php echo wp_theme_credits(3); ?></div><!-- #credits -->
