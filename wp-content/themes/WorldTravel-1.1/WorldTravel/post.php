<?php global $theme; ?>
    ...
    <div <?php post_class('post clearfix'); ?> id="post-<?php the_ID(); ?>">
        ...
        <div class="">
            <a href="<?php the_permalink(); ?>#more-<?php the_ID(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'themater' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php $theme->option(''); ?></a>
        </div>
        <?php } ?>
